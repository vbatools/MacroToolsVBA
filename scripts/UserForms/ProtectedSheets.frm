...
58:             Select Case SH.ProtectContents
                Case True
60:                     .Selected(n) = True
61:                     .List(n, 3) = "protection is there"
62:                     .List(n, 4) = "***********"
63:                     Case False
64:                     .List(n, 3) = "of protection no"
65:                     End Select
66:             n = n + 1
67:             Next
68:         End With
...
74:             If CheckBox2 And .List(i, 3) = "protection is there" Then
75:                 .Selected(i) = True
76:                 Else
77:                 .Selected(i) = False
78:                 End If
