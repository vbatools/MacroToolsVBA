...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Module     : VersionSistemControls - система контроля версий файлов
...
'* глобальная переменая содержащая информацию из файла Config.cvs
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : VersionList; GetTypeCoomment; ParserCommet - парсер Config.cvs нужно обновлять две функции и перечисление
'* Created    : 10-03-2020 09:30
'* Author     : VBATools
'* Contacts   : http://vbatools.ru/ https://vk.com/vbatools
'* Copyright  : VBATools.ru
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : GetTypeCoomment - получение названия по перечислению
...
'* ByVal iItem As VersionList     : номер искомого из перечисления
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
139:
140:    'обновление или создание комментария
...
320: End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : CheckSourcePath - главная процедура
...
370: End Sub
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : RefrashListVersion обновление ListBox, названия файлов версий
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : GetNomerItemSelectedList - номер выделеного значения в листбоксе
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : GetCodeFromModule - строковая переменая, возращающает текст файла модуля "ЭтаКнига"
...
501: End Function
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : AddListModuleName - строковая переменая, содержащия имена всех модулей выбранной книги
...
524: End Function
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : AddCommentForModule - создание комментария
...
'* sVersion As String    : версия
'* sCreated As String    : дата создания
'* sOldVersion As String : предыдущая версия
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
560: End Function
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : AddCommentVSC - процедура внедрения комментраия в код модуля
