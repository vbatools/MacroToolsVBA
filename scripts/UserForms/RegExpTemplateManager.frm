...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Module     : RegExpTemplateManager - шаблоны регулярных выражений
...
231:
232:    Call SortTableListObject(objListPattern, "tbPattern[[#All],[Патеррн]]")
233:    Call SortTableListObject(objListPattern, "tbPattern[[#All],[Группа]]")
234:
...
240:
241:    Call SortTableListObject(objListGrup, "tbGrupa[[#All],[Группа]]")
242:
243:    ListGrup.Clear
