...
42:        End With
43:    Else
44:        Call MsgBox("Nothing is selected!", vbCritical, "Insert pattern:")
45:    End If
46: End Sub
...
160:                                Call MsgBox("Group [" & txtItemGrupa.Value & "]" & vbNewLine & "You didn't rename it!", vbCritical + vbOKOnly, "Changing a group:")
161:                            Else
162:                                If MsgBox("Are you sure you want to change the group [" & SelectedItemList(ListGrup) & "] on [" & txtItemGrupa.Value & "] ?", vbQuestion + vbYesNo, "Changing a group:") = vbYes Then
163:                                    objListGrup.ListRows(objFinde.Row - 1).Range.Value = txtItemGrupa.Value
164:                                    Call UpdateTBGruppa
165:                                    Call MsgBox("Group [" & SelectedItemList(ListGrup) & "] changed to [" & txtItemGrupa.Value & "]", vbInformation + vbOKOnly, "Changing a group:")
166:                                End If
167:                            End If
168:                        End If
169:                    End If
...
196:                            If MsgBox("Are you sure you want to delete a template [" & txtItemPattern.Value & "] ?", vbQuestion + vbYesNo, "Deleting a template:") = vbYes Then
...
208:                                Call MsgBox("Template [" & txtItemPattern.Value & "]" & vbNewLine & "You didn't rename it!", vbCritical + vbOKOnly, "Changing the template:")
209:                            Else
210:                                If MsgBox("Are you sure you want to change the group [" & SelectedItemList(ListTemplete) & "] on [" & txtItemPattern.Value & "] ?", vbQuestion + vbYesNo, "Changing the template:") = vbYes Then
...
231:
232:    Call SortTableListObject(objListPattern, "tbPattern[[#All],[Pattern]]")
233:    Call SortTableListObject(objListPattern, "tbPattern[[#All],[Group]]")
234:
...
240:
241:    Call SortTableListObject(objListGrup, "tbGrupa[[#All],[Group]]")
242:
243:    ListGrup.Clear
