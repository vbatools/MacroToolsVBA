...
49:    Select Case Err.Number
        Case 0
51:        Case Else
52:            Debug.Print "Ошибка! в U_UpperAndLowerCase.toUpperCase" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
...
98:    Select Case Err.Number
        Case 0
100:        Case Else
101:            Debug.Print "Ошибка! в U_UpperAndLowerCase.toLowerCase" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "в строке " & Erl
