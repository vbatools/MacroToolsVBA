...
102:    GetUpdate = False
103: End Function
'проверяю даты запрос раз в 10 дней
...
112:    'запуск проверки обновлений раз в десять дней
